    ...
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 my-30">
        <div className="space-y-5">
          <p className="text-[10px] text-[#ccff00]">WORKOUT LIBRARY</p>
          <h1 className="text-5xl uppercase font-bold">TRAIN WITH INTENT. LOG EVERY SET.</h1>
          ...
          <Link href='#library'><button className="bg-[#ccff00] text-[10px] text-black font-bold pb-2 pt-3 px-5 rounded">BROWSE WORKOUTS</button></Link>
        </div>
